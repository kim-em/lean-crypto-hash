...
checks output sizes, strict hex round trips and canonical output, exact `ByteVector` equality and
no-early-exit comparison results, HMAC sizes and incremental chunk equivalence, SHAKE split
reads, padding alignment, and endian serialization round trips.
